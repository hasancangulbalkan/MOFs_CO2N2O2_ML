...
tpot_data = pd.read_excel('O2_01BAR.xlsx',  dtype=np.float64)
...
# Average CV score on the training set was: -4.3939868066649265e-07
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=GradientBoostingRegressor(alpha=0.95, learning_rate=0.1, loss="huber", max_depth=10, max_features=0.4, min_samples_leaf=20, min_samples_split=16, n_estimators=100, subsample=0.15000000000000002)),
    ZeroCount(),
    RobustScaler(),
    RidgeCV()
)
