...
# Average CV score on the training set was: -0.0001798760810372951
exported_pipeline = make_pipeline(
    ZeroCount(),
    ExtraTreesRegressor(bootstrap=False, max_features=0.7500000000000001, min_samples_leaf=1, min_samples_split=7, n_estimators=100)
)
