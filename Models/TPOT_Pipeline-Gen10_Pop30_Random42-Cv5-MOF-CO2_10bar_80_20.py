...
# Average CV score on the training set was: -0.6017117673344405
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=8, min_child_weight=7, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.8500000000000001, verbosity=0)
