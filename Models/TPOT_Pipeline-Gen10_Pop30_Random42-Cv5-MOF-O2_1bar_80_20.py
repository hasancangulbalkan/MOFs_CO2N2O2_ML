...
# Average CV score on the training set was: -0.0005245873504817996
exported_pipeline = make_pipeline(
    RobustScaler(),
    RandomForestRegressor(bootstrap=False, max_features=0.7500000000000001, min_samples_leaf=2, min_samples_split=9, n_estimators=100)
)
