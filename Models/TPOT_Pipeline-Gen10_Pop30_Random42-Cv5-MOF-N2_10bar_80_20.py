...
# Average CV score on the training set was: -0.02238761100489386
exported_pipeline = ExtraTreesRegressor(bootstrap=False, max_features=1.0, min_samples_leaf=1, min_samples_split=8, n_estimators=100)
